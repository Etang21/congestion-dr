...
\begin{itemize}    
    ...
    \item Externalities? Redistribution with differential externalities by group. Or e.g. schooling has externalities.
    
    \item Approximately optimal mechanisms? Those with unknown distributions that must be learned?
\end{itemize}
...
\begin{enumerate}    
    ...
    \item Very interesting: taking \cite{akbarpour-2020} or \cite{dworczak-2020} as a departure point, what if there are different externalities by group? Motivating question is the distribution of vaccines here, but one could imagine others.
